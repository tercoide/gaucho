...
public static class Gcd
    ...
    // CAD colors
        ...
        //                     Inc i
        //                     hlty.TrameLength.Add(Abs(Gb.CDbl(c[sNextKey])) * 2.5) // TODO: verificar este valor arbitrario
        ...
        //         hlty.sFont_3 = c["3"]
        //
        //         hlty.FixedH_40 = Gb.CDbl(c["40"])
        //
        //         // Esto no puede usarse asi, LastHeightUsed_2 es solo un dato de historial
        //         // If hlty.FixedH_40 = 0 Then hlty.FixedH_40 = Gb.CDbl(c["42"])
        //
        ...
        //
        //         Try hlty.fArrowSize_41 = Gb.CDbl(c["41"])
        //         If hlty.fArrowSize_41 = 0 Then hlty.fArrowSize_41 = 1
        //
        //         Try hlty.fTxtHeight_140 = Gb.CDbl(c["140"])
    ...
    //             {
    //                 return Gb.CDbl(Drawing.cHeader[VarName][Drawing.cHeader[VarName].First]);
    //             }
    //             else
    //             {
    ...
    public static string LibreDWGtoDXF(string sDwgFile)
    {
        ...
        do
        {
            ...
            else if (s != "")
            {
                ...
                s = Gb.Replace(s, " ", "");
                sp = Gb.Split(s, ",");
                p.AngleDeg = Gb.CDbl(sp[0]);
                p.BaseX = Gb.CDbl(sp[1]);
